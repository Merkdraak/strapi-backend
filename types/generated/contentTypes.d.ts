...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerOrganization: Schema.Attribute.Component<'nav.footer-link', true>;
    footerServices: Schema.Attribute.Component<'nav.footer-link', true>;
    items: Schema.Attribute.DynamicZone<
      ['nav.mega', 'nav.dropdown', 'nav.link']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mobileTopics: Schema.Attribute.Relation<'oneToMany', 'api::page.page'>;
    publishedAt: Schema.Attribute.DateTime;
    site: Schema.Attribute.Relation<'oneToOne', 'api::site.site'>;
    siteKey: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Titel, URL, status en blokken. Technische sleutels vult het systeem zelf.';
    displayName: 'Pagina';
    pluralName: 'pages';
    singularName: 'page';
  };
